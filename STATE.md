...
- [~] **(M)** T-422 [research] Run OBD1 engine-chapter matrix extraction (PDF->PNG + default profile + inline rescue, ~150-250 pages, ~$4-10) -- BLOCKED: all upstream deps (T-414 through T-418b) still [ ]; see reports/t-422-research-run-obd1-engine.md -- full spec: docs/plans/04b-torque-fastener-index.md @ T-422
