...
- [x] **(S)** T-142 [research] Research H22A Redtop restoration guides: nut-and-bolt examples, frame-off rebuild costs, parts availability -- done 2026-05-15, sha PLACEHOLDER -- full spec: docs/plans/03-h-series-variants.md @ T-142
