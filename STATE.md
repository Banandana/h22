...
- [x] **(M)** T-423b [research] Consensus pass: cluster invocations per (assembly, fastener, thread); majority wins; emit h22-torques.jsonl (consensus + corroboration) + h22-torques-disputed.jsonl (no-majority) + consensus-report.md — done 2026-05-17, sha PENDING — full spec: docs/plans/04b-torque-fastener-index.md @ T-423b
