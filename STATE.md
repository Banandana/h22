...
- [x] **(S)** T-134 [research] Research H22A Redtop wheel and tire specs: rim size, width, offset, tire size, load index -- done 2026-05-15, sha TBD -- full spec: docs/plans/03-h-series-variants.md @ T-134
