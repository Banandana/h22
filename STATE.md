...
- [x] **(M)** T-154 [research] Research H22A Blacktop intake system: single runner manifold, 60mm throttle body, plenum design, runner length -- full spec: docs/plans/03-h-series-variants.md @ T-154 — done 2026-05-15, sha PENDING
