...
- [x] **(M)** T-424b [research] Disputed-row resolution: walk h22-torques-disputed.jsonl, surface PNG + candidates, accept manual pick or mark unresolved; resolved rows move to h22-torques.jsonl — done 2026-05-17, sha PENDING — full spec: docs/plans/04b-torque-fastener-index.md @ T-424b
