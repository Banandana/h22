...
- [ ] **(M)** T-436 [fix] Post-processing normalizer: iterate ALL envelope array items (not just first); collect every item passing enrichment into response_parsed — full spec: reports/t-430-checkpoint-phase-4b-checkpoint.md @ T-436
