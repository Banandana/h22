...
- [ ] **(M)** T-437 [fix] OBD1 extraction fix: investigate {incomplete json responses; fix thinking-mode leakage or image crop issues; re-run OBD1 engine chapters — full spec: reports/t-430-checkpoint-phase-4b-checkpoint.md @ T-437
- [ ] **(L)** T-438 [research] Re-run BB6 matrix extraction with fixed prompt (T-435) + fixed normalizer (T-436); expected significant row count increase; re-run consensus pass — full spec: reports/t-430-checkpoint-phase-4b-checkpoint.md @ T-438
