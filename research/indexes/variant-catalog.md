...
| **Research file** | **research/h-series/specifications/h22a3-specifications.md** | **H22A3 focused specifications: 190 PS @ 6,800 RPM output, 10.6:1 compression ratio, detailed differences from H22A1 (higher CR 10.6:1 vs 10.0:1, moderate emissions vs strict EPA, identical power) and H22A4 (closed vs open deck, 50mm vs 55mm mains, OBD1 vs OBD2 ECU, 190 vs 200 PS), production numbers estimate (700–2,000 units, 1996 only), applications (BB1 Prelude VTEC, CD8 Accord Coupe SiR), identification guide (VIN KU code, under-hood label, block stamp unknown), comparison matrix vs H22A1/H22A4** | 2026-05-15
| **Research file** | **research/h-series/variants/h22a3-collector-status.md** | **H22A3 collector status comprehensive research: rarity assessment (extreme — ~700–2,000 units, single-year 1996 production, no US/JDM presence), demand analysis (near-zero current demand, emerging drivers: rising K-series prices, analog driving renaissance, improved aftermarket support), pricing trends ($1,800–$3,600 engine range tracking H22A1, no premium yet, sleeper potential 10–20% upside in 5–7 years), identification markers (VIN KU code primary method, under-hood emissions label definitive, block stamp range unknown — biggest knowledge gap, chassis code cross-reference BB1/CD8), collector status summary (awareness near-zero, swap utility excellent, premium potential low-moderate)** | 2026-05-15
...
| **Research file** | **research/h-series/variants/h22a4-applications.md** | **H22A4 applications comprehensive: USDM Base and Type SH trims, Canadian SE trim (2001 only), Australian VTi-R/VTi-R ATTS (H22A4 1997–1998, H22Z1 1999–2001), European 2.2 VTi/VTi-S (H22A5/H22A8), JDM trims (no H22A4 code used), complete chassis code matrix (BB5–BB9), model year evolution (1997–1999 vs 1999–2001 facelift +5 hp M/T), pricing ($23,595–$26,365), feature comparison matrices (Base vs SH vs SE), Sequential SportShift automatic, VIN decode reference, sales data (~58,118 total 5th-gen), competitive landscape, trim-level specifications** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-atts.md** | **H22A4 Active Torque Transfer System (ATTS) on 5th gen Prelude Type-SH: MCU replacing intermediate shaft, triple-pinion planetary gears (16 gears observed in teardown), dual hydraulic wet clutches (3 clutches + 4 friction plates), oil pump, oil cooler hoses, breather tube routing; fluid specs (Honda Genuine ATF, 1 qt capacity, 30,000 mi interval); DTC codes 61–66 with blink pattern retrieval; OEM part numbers (41200-P6K-010 → P6K-020); sensor complement (TPS, steering angle, yaw rate, wheel speed, lateral G); applications (USDM Type-SH, CAN SE Premium, AUS VTi-R ATTS); integration with M2F4 transmission, P13 ECU communication; common failure modes; performance impact (Car and Driver Best-Handling <$30K winner); community teardown photos and maintenance procedures** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-trim-comparison-sh-se-base.md** | **H22A4 trim comparison Type-SH vs SE vs Base: feature packages, pricing ($23,595–$26,540 MSRP), desirability, collectibility (Hagerty #1 ~$36K), ATTS differential details, exterior/interior differences, VIN identification guide, year-by-year evolution, quick-reference decision matrix** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-us-market-reception.md** | **H22A4 US market reception: magazine reviews (C/D Nov 1996 "Tested" — 7.2s 0-60, 15.6s @ 91 mph, won Best Handling <$30K; R&T retrospective on ATTS innovation; MotorTrend/Automobile retro drives), owner satisfaction (KBB 4.8/5, 97% recommend, 83% five-star across 293 reviews; Edmunds praise for handling/VTEC; Honda-Tech/PreludePower consensus on ATTS appreciation and immobilizer frustration), resale values (Classic.com avg $14,604 / top sale $60K Type SH; Hagerty #1 ~$36K / #2 ~$25.8K / #3 ~$14.1K; KBB aggregate ~$2,600–$2,900 average-condition), sales context (~58,118 total 5th-gen units; competitive positioning vs Integra GS-R/Type R, Eclipse, Corrado, Miata), reliability reputation (timing belt tensioner every 80K mi, water pump leaks, ATTS clutch wear, immobilizer headaches, oil consumption after 150K mi)** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-specifications.md** | **H22A4 full technical specification sheet: power/torque output (195–200 PS @ 7,000 RPM, 212 Nm @ 5,250 RPM), compression ratio 10.0:1, internal component dimensions (rod length 143mm, wrist pin 22mm, main journals 50mm→55mm, rod journals 47.95mm), camshaft profiles (288°/308°, 11.38/10.54 mm lift), intake/exhaust systems (single runner, 62mm TB, 51mm exhaust), ECU (P13 OBD2), fluid capacities, timing belt system, ignition, valve adjustment specs, torque specs, sensor complement, VTEC engagement parameters, comparison vs H22A1/Redtop/Blacktop** | 2026-05-15 |
| **Research file** | **research/h-series/engine-management/h22a4-p13-ecu-immobilizer-tuning.md** | **H22A4 P13 ECU comprehensive: P13-A12 (1996 OBD2A, no immobilizer, extremely rare) vs P13-A13/Bxx (1997–2001 OBD2B, immobilizer-integrated); immobilizer system operation (EEPROM chip + key transponder); bypass methods (chip swap, Rywire harness conversion); tuning limitations (P13 fuel maps locked, no software can open/read bins); custom chips (Spoon 5000 VTEC/8500 redline, KS-ROM 5500 VTEC/9000 redline, Mugen 5500 VTEC/9200 redline); Hondata compatibility (S300 requires chippable OBD1 ECU, FlashPro does NOT support H22 P13 family); recommended path: convert to P28 via harness converter + TD-60U distributor** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-open-deck-block-architecture.md** | **H22A4 open deck block architecture: 1997 transition from H22A1 closed deck, structural implications of open deck design, 55mm main journal increase (1998+), block rigidity characteristics, FRM liner technology in open deck context, cooling jacket design differences, community debate on boost potential (stock bottom end ~250–280 HP), identification of 50mm vs 55mm blocks, crankshaft interchangeability constraints, bearing selection guide** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-single-runner-intake.md** | **H22A4 single runner intake manifold: design vs dual-runner (H22A Redtop), plenum volume specifications, power band characteristics (peak 212 Nm @ 5,250 RPM, broader low-end torque), real-world dyno data, variant mapping (H22A4/H22A7/H22Z1 single-runner vs H22A Redtop/Blacktop dual-runner), tuning implications (bolt-on gains, aftermarket options from SpeedFactory Racing/Yonaka/Spoon), swap compatibility, airflow limitations at high RPM** | 2026-05-15 |
| **Research file** | **research/h-series/engine-management/h22a4-obd2-diagnostics.md** | **H22A4 OBD2 diagnostics: 16-pin DLC pinout (pins 4=gnd, 5=signal gnd, 16=battery +12V, 6=CAN HL, 14=CAN LL, 7=K-line, 15=L-line); scan tool requirements (basic OBD2 scanner vs Honda HDS vs GnG TD-60U); live data streams with normal operating ranges (MAP 1.0–4.8V, TPS 0.5–4.5V, O2 0.1–0.9V switching); readiness monitors (IAT, ECT, MPS, CATAL, EGR, O2, O2 Heater, EVAP, A/C, FCM); DTC code set (P0100–P0199, P0300–P0399, P0400–P0499, P0500–P0599, P0600–P0699, P1100–P1199 Honda-specific, P1200–P1299 fuel/injection, P1300–P1399 ignition/VTEC including P1259, P1345, P1346); manual diagnostic mode SCS switch procedure** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-5th-gen-prelude-redesign.md** | **H22A4 5th gen Prelude redesign: exterior styling changes (Cd 0.30 vs 0.34, +50mm length, +30mm width, −10mm height, +20mm wheelbase), interior updates (driver-oriented dashboard, new instrument cluster, revised center console, sound deadening), chassis stiffening (+15% torsional rigidity), weight changes by trim (Base ~1,280 kg, Type-SH ~1,310 kg), suspension revisions (caster +1°, camber −1°), brake upgrades (front 276mm vs 262mm 4th gen)** | 2026-05-15 |
| **Research file** | **research/h-series/specifications/h22a4-main-journal-increase.md** | **H22A4 main journal increase: 1997 50mm to 1998+ 55mm engineering rationale (increased crankshaft stiffness, improved bearing support), crankshaft differences (part numbers, counterweight design, oil hole pattern), bearing part number changes (50mm → 55mm standard bore, oversize options .25/.50/.75mm), block casting differences and visual identification marks, swap/rebuild implications (55mm crank cannot go in 50mm block), strength comparison (55mm provides ~40% more bearing surface area)** | 2026-05-15 |
...
| **Research file** | **research/h-series/variants/h23a-internal-oil-passage-vtec-solenoid.md** | **H23A internal oil passage for VTEC solenoid — detailed research** | **Factory-modified internal oil passage unique to H23A VTEC block, enabling H22A-derived head VTEC operation; oil pressure specifications (7–10 psi at idle, ~60 psi general engine oil); failure modes (gasket leak, clogged screen, oil pressure switch failure P1259, solenoid internal wear, insufficient oil pressure); swap relevance (H23A block + H22A head VTEC conversion path); maintenance recommendations; cross-reference comparison table of all H-series variants' oil passage configurations** | 2026-05-15
